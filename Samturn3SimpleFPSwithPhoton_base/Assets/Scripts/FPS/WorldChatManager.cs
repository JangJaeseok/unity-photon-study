...
public partial class WorldChatManager : MonoBehaviour, IChatClientListener {
	...
	public void OnSubscribed(string[] channels,bool[] results){  // 처음 채널 구독 시작됐음을 알림
	...
	public void OnGetMessages(string channelName, string[] senders, object[] messages)  // 일반 메시지 받기
	{
